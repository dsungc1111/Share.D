...
### **문제 2**:   **리프레시 토큰을 활용하여, 액세스 토큰 갱신까지는 성공이지만 기능이 실행 X.**
...
### **해결**: 
- UserDefault 속성 래퍼가 해당 값을 UserDefaults.standard와 제대로 동기화하지 않거나 UserDefaults를 업데이트하는 서로 다른 방법을 혼합하는 경우 **Old Value**가 발생  
